...
//	g, err := NewGoWSDL("fixtures/test.wsdl", "myservice", nil, false, true)
//	if err != nil {
//		t.Error(err)
//	}
...
//		g, err := NewGoWSDL(file, "myservice", nil, false, true)
//		if err != nil {
//			t.Error(err)
//		}
...
//		g, err := NewGoWSDL("fixtures/"+fixtureWsdl, "myservice", nil, false, true)
//		if err != nil {
//			t.Error(err)
//		}
...
//	g, err := NewGoWSDL("fixtures/workday-time-min.wsdl", "myservice", nil, false, true)
//	if err != nil {
//		t.Error(err)
//	}
...
//	g, err := NewGoWSDL("./fixtures/epcis/EPCglobal-epcis-query-1_2.wsdl", "myservice", nil, true, true)
//	if err != nil {
//		t.Error(err)
//	}
